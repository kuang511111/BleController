 ...
 */
@SuppressLint("NewApi")
public class BluetoothLeService6 extends Service implements ISendCommondManager
{
    private final static String TAG = BluetoothLeService6.class.getSimpleName();
    private static BluetoothLeService6 mBluetoothLeService;
    ...
    public static BluetoothLeService6 getInstance()
    {
    ...
    public static void setmBluetoothLeService(BluetoothLeService6 mBluetoothLeService)
    {
        BluetoothLeService6.mBluetoothLeService = mBluetoothLeService;
    }
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (Constants.ACTION_BLE_DISCONNECT_SERVICE6.equals(action))
            {
                disconnect();
            }
        }
    ...
    public void onCreate()
    {
        ...
        intentFilter.addAction(Constants.ACTION_BLE_DISCONNECT_SERVICE6);
