 ...
 */
@SuppressLint("NewApi")
public class BluetoothLeService2 extends Service implements ISendCommondManager
{
    private final static String TAG = BluetoothLeService2.class.getSimpleName();
    private static BluetoothLeService2 mBluetoothLeService;
    ...
    public static BluetoothLeService2 getInstance()
    {
    ...
    public static void setmBluetoothLeService(BluetoothLeService2 mBluetoothLeService)
    {
        BluetoothLeService2.mBluetoothLeService = mBluetoothLeService;
    }
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (Constants.ACTION_BLE_DISCONNECT_SERVICE2.equals(action))
            {
                disconnect();
            }
        }
    ...
    public void onCreate()
    {
        ...
        intentFilter.addAction(Constants.ACTION_BLE_DISCONNECT_SERVICE2);
