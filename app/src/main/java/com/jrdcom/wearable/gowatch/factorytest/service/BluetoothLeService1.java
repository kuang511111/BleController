 ...
 */
@SuppressLint("NewApi")
public class BluetoothLeService1 extends Service implements ISendCommondManager
{
    private final static String TAG = BluetoothLeService1.class.getSimpleName();
    private static BluetoothLeService1 mBluetoothLeService;
    ...
    public static BluetoothLeService1 getInstance()
    {
    ...
    public static void setmBluetoothLeService(BluetoothLeService1 mBluetoothLeService)
    {
        BluetoothLeService1.mBluetoothLeService = mBluetoothLeService;
    }
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (Constants.ACTION_BLE_DISCONNECT_SERVICE1.equals(action))
            {
                disconnect();
            }
        }
    ...
    public void onCreate()
    {
        ...
        intentFilter.addAction(Constants.ACTION_BLE_DISCONNECT_SERVICE1);
