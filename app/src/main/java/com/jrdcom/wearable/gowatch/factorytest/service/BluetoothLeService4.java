 ...
 */
@SuppressLint("NewApi")
public class BluetoothLeService4 extends Service implements ISendCommondManager
{
    private final static String TAG = BluetoothLeService4.class.getSimpleName();
    private static BluetoothLeService4 mBluetoothLeService;
    ...
    public static BluetoothLeService4 getInstance()
    {
    ...
    public static void setmBluetoothLeService(BluetoothLeService4 mBluetoothLeService)
    {
        BluetoothLeService4.mBluetoothLeService = mBluetoothLeService;
    }
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (Constants.ACTION_BLE_DISCONNECT_SERVICE4.equals(action))
            {
                disconnect();
            }
        }
    ...
    public void onCreate()
    {
        ...
        intentFilter.addAction(Constants.ACTION_BLE_DISCONNECT_SERVICE4);
