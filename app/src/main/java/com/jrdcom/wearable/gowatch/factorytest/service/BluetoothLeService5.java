 ...
 */
@SuppressLint("NewApi")
public class BluetoothLeService5 extends Service implements ISendCommondManager
{
    private final static String TAG = BluetoothLeService5.class.getSimpleName();
    private static BluetoothLeService5 mBluetoothLeService;
    ...
    public static BluetoothLeService5 getInstance()
    {
    ...
    public static void setmBluetoothLeService(BluetoothLeService5 mBluetoothLeService)
    {
        BluetoothLeService5.mBluetoothLeService = mBluetoothLeService;
    }
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (Constants.ACTION_BLE_DISCONNECT_SERVICE5.equals(action))
            {
                disconnect();
            }
        }
    ...
    public void onCreate()
    {
        ...
        intentFilter.addAction(Constants.ACTION_BLE_DISCONNECT_SERVICE5);
