 ...
 */
@SuppressLint("NewApi")
public class BluetoothLeService7 extends Service implements ISendCommondManager
{
    private final static String TAG = BluetoothLeService7.class.getSimpleName();
    private static BluetoothLeService7 mBluetoothLeService;
    ...
    public static BluetoothLeService7 getInstance()
    {
    ...
    public static void setmBluetoothLeService(BluetoothLeService7 mBluetoothLeService)
    {
        BluetoothLeService7.mBluetoothLeService = mBluetoothLeService;
    }
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (Constants.ACTION_BLE_DISCONNECT_SERVICE7.equals(action))
            {
                disconnect();
            }
        }
    ...
    public void onCreate()
    {
        ...
        intentFilter.addAction(Constants.ACTION_BLE_DISCONNECT_SERVICE7);
